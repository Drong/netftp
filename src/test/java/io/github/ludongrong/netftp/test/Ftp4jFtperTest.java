...
public class Ftp4jFtperTest {
    ...
    public void beforeClass() {
        ...
        fBuilder.withType(FtperConfig.TypeEnum.ftp4j);

        FtperConfig ftperConfig = fBuilder.build();

        Ftp4jFtper.Builder builder = new Ftp4jFtper.Builder();
