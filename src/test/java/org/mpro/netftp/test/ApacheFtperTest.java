...
import org.mpro.netftp.ApacheFtper;
...
public class ApacheFtperTest {
    ...
    public static void main(String[] args) {
        ...
        fBuilder.withType(FtperConfig.TypeEnum.apache_common);

        FtperConfig ftperConfig = fBuilder.build();

        ApacheFtper.Builder builder = new ApacheFtper.Builder();
        IFtper ftper = builder.build(ftperConfig);
        ftper.listFile("/").forEach(obj -> {
