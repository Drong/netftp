 ...
 * @version 1.0
 * @created 22-十一月-2020 22:09:17
 */
public class FileFiler implements Filter {
     ...
     *            方向
     */
    public FileFiler(String regulation, boolean direction) {
    ...
    public void doFilter(WatcheParam watcheParam, FilterChain filterChain) {
        ...
        boolean result = matcher.match(regulation, watcheParam.getName());
